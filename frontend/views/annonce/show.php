...
<head>
    ...
    <style>
        ...
        .gallery-main {
            ...
            height: 400px; background: #f4f6f8; position: relative;
        }
        ...
        .gallery-thumb {
            ...
            flex-shrink:0;border:2px solid #e5e7eb;cursor:pointer;
            opacity:.7;transition:border-color .15s,opacity .15s;
        }
        .gallery-thumb.active, .gallery-thumb:hover { border-color:#0056b3;opacity:1; }
        .gallery-thumb img { width:100%;height:100%;object-fit:cover; }

        .price-big {
            font-size:2rem;font-weight:900;color:#0056b3;line-height:1;
        }
        ...
        .btn-action {
            ...
            transition:opacity .15s,transform .1s;font-family:'Poppins',sans-serif;
        }
        ...
        .btn-action--ghost {
            background:#f9fafb;color:#374151;border:1.5px solid #e5e7eb !important;
        }
...
<!-- Modales owner : changer type / statut -->
        ...
        <div class="modal-box" style="max-width:380px;">
            ...
            <form method="POST" action="/annonces/type/<?= $annonce->getId() ?>">
                ...
                <div class="modal-field">
                    ...
                    <select name="type" class="modal-field input">
                        <?php foreach (['vente' => 'Vente', 'don' => 'Don (gratuit)', 'location' => 'Location'] as $v => $l): ?>
...
<main class="flex-1" style="max-width:1100px;margin:0 auto;width:100%;padding:24px 20px 56px;">
    ...
    <div style="display:grid;grid-template-columns:1fr 310px;gap:24px;align-items:start;">
        ...
        <!-- Colonne gauche -->
        <div>
            <!-- Galerie — cover en premier -->
            <div style="margin-bottom:16px;">
                <div class="gallery-main">
                    <?php
                    // On trie : cover en premier, puis les autres
